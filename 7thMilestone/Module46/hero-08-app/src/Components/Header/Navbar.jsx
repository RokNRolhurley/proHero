         ...
         <div className="navbar bg-base-100 shadow-sm bg-white">
                <div className="navbar-start">
                    ...
                    <ul
                        ...
                        <li>
                        <a className='text-black'>Apps</a>
                        </li>
                        <li><a className='text-black'>Installation</a></li>
                    </ul>
                    </div>
                    <div className='flex'>
                        <img src={heroIcon} className='h-15 w-15'/>
                        <span className="text-xl mt-4 text-black ">HERO.IO</span>
            ...
            <div className="navbar-center hidden lg:flex">
                    ...
                    <li><a className='text-black'>Home</a></li>
                    <li><a className='text-black'>Apps</a></li>
                    <li><a className='text-black'>Installation</a></li>
                    </ul>
                </div>
